...
def run_enrichment(
    ...
    *,
    ...
    from sdr_cli.db import add_contact_method, get_people_without_work_email
    from sdr_cli.models import ContactMethod
    from sdr_cli.enrichers.apollo import split_name
